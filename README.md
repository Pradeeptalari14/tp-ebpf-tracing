...
[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/ebpf-tracing/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/ebpf-tracing/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-ebpf-tracing.git
cd tp-ebpf-tracing
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/ebpf-tracing/) |
